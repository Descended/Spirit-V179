...
public enum OutHeader {
    ...
    // Commenting updated OPs - Brandon
    // CWvsContext::OnPacket
    INVENTORY_OPERATION(71), // 73
    INVENTORY_GROW(72), // 74
    STAT_CHANGED(73), // 75
    TEMPORARY_STAT_SET(74), // 76
    TEMPORARY_STAT_RESET(75),// 77
    FORCED_STAT_SET(76), // 78
    FORCED_STAT_RESET(77), // 79
    CHANGE_SKILL_RECORD_RESULT(78), // 80
    CHANGE_STEAL_MEMORY_RESULT(79), // 81
    USER_DAMAGE_ON_FALLING_CHECK(80), // 82
    PERSONAL_SHOP_BUY_CHECK(81), // 83
    MOB_DROP_MESO_PICKUP(82), // 84
    BREAK_TIME_FIELD_ENTER(83),// 85
    RUNE_ACT_SUCCESS(84),// 86
    RESULT_STEAL_SKILL_LIST(85), // 87
    SKILL_USE_RESULT(86), // 88
    EXCL_REQUEST(87),// 89
    GIVE_POPULARITY_RESULT(88), // 90
    MESSAGE(89), // 91
    MEMO_RESULT(90), // 92
    MAP_TRANSFER_RESULT(91), // 93
    ANTI_MACRO_RESULT(92), // 94
    ANTI_MACRO_BOMB_RESULT(93), // 95
    CLAIM_RESULT(95), // 97
    SET_CLAIM_SVR_AVAILABLE_TIME(96), // 98
    CLAIM_SVR_STATUS_CHANGED(97), // 99
    STAR_PLANET_USER_COUNT(98), // 100
    SET_TAMING_MOB_INFO(99),  // 101
    QUEST_CLEAR(100), // 102
    ENTRUSTED_SHOP_CHECK_RESULT(101), // 103
    SKILL_LEARN_ITEM_RESULT(102), // 104
    SKILL_RESET_ITEM_RESULT(103), // 105
    ABILITY_RESET_ITEM_RESULT(104), // 106
    EXP_CONSUME_ITEM_RESULT(105),// 107
    EXP_ITEM_GET_RESULT(106),// 108
    CHAR_SLOT_INC_RESULT(107),// 109
    CHAR_RENAME_RESULT(108), // 110
    GATHER_ITEM_RESULT(109),// 111
    SORT_ITEM_RESULT(110),// 112
    CHARACTER_INFO(113),// 115
    PARTY_RESULT(114), // 116
    PARTY_MEMBER_CANDIDATE_RESULT(115), //117
    URUS_PARTY_MEMBER_CANDIDATE_RESULT(116), // 118
    PARTY_CANDIDATE_RESULT(117), // 119
    URUS_PARTY_RESULT(118), // 120
    INTRUSION_FRIEND_CANDIDATE_RESULT(119),//121
    INTRUSION_LOBBY_CANDIDATE_RESULT(120),// 122
    EXPEDITION_RESULT(122), // 124
    FRIEND_RESULT(123), // 125
    STAR_FRIEND_RESULT(124), // 126
    LOAD_ACCOUNT_ID_OF_CHARACTER_FRIEND_RESULT(125), // ???
    GUILD_REQUEST(126), // 127
    GUILD_RESULT(127), // 128
    ALLIANCE_RESULT(128), // 129
    TOWN_PORTAL(129), // 130
    BROADCAST_MSG(130), // 131
    INCUBATOR_RESULT(132), // 133
    INCUBATOR_HOT_ITEM_RESULT(133),// 134
    SHOP_SCANNER_RESULT(134), // 135
    SHOP_LINK_RESULT(135), // 136
    AUCTION_RESULT(136), // ??
    AUCTION_MESSAGE(137), // 138
    MARRIAGE_REQUEST(138), // 137
    MARRIAGE_RESULT(139), // 138
    WEDDING_GIFT_RESULT(140), // Unknown as of now
    NOTIFY_MARRIED_PARTNER_MAP_TRANSFER(141), // Unknown as of now
    CASHPET_FOOD_RESULT(142), // 141
    CASHPET_PICK_UP_ON_OFF_RESULT(143), // 142
    CASHPET_SKILL_SETTING_RESULT(144), // 143
    CASH_LOOK_CHANGE_RESULT(145), // 144
    CASHPET_DYEING_RESULT(146),// 145
    SET_WEEK_EVENT_MESSAGE(147),// 146
    SET_POTION_DISCOUNT_RATE(148), // 147
    BRIDLE_MOB_CATCH_FAIL(149), // 148
    IMITATED_NPC_RESULT(150), // 150
    IMITATED_NPC_DATA(151), // 152
    LIMITED_NPC_DISABLE_INFO(153), // ???
    MONSTER_BOOK_SET_CARD(154), // 153
    MONSTER_BOOK_SET_COVER(155), // 154
    HOUR_CHANGE(156), // 155
    MINIMAP_ON_OFF(157), // 156
    CONSULT_AUTH_KEY_UPDATE(158), // 157
    CLASS_COMPETITION_AUTH_KEY_UPDATE(159), // 158
    WEB_BOARD_AUTH_KEY_UPDATE(160), // 159
    SESSION_VALUE(161), // 160
    PARTY_VALUE(162), // 161
    FIELD_SET_VARIABLE(163), // ??
    FIELD_VALUE(164), // 163
    BONUS_EXP_RATE_CHANGED(165), //164
    ...
    NOTIFY_LEVEL_UP(177), // 176
    NOTIFY_WEDDING(178),
    NOTIFY_JOB_CHANGE(179), // 178
    SET_BUY_EQUIP_EXT(180),
    SET_PASSENSER_REQUEST(181), // typo? // 180
    ...
    ZERO_INFO(193), // 192
    ZERO_WP(194), // 193
    ZERO_INFO_SUB_HP(195), // 194
    UI_OPEN(196), // 195
    CLEAR_ANNOUNCED_QUEST(197),
    RESULT_INSTANCE_TABLE(198),
    COOL_TIME_SET(199), // 198
    ITEM_POT_CHANGE(200), // 199
    ...
    // I will be commenting OP codes for v179 - Brandon
    // Note all the commented values are opcodes for v179
    TRANSFER_FIELD_REQ_IGNORED(432), // 453
    TRANSFER_CHANNEL_REQ_IGNORED(433), // 454
    TRANSFER_PVP_REQ_IGNORED(434), // 455
    FIELD_SPECIFIC_DATA(435), // 456
    GROUP_MESSAGE(436), // 457
    FIELD_UNIVERSE_MESSAGE(437), // 458
    WHISPER(438), // 459
    SUMMITEM_INAVAILABLE(439), // 460
    FIELD_EFFECT(440), // 461
    BLOW_WEATHER(448), // 462
    PLAY_JUKE_BOX(449), // 463
    ADMIN_RESULT(450), // 464
    QUIZ(451), // 465
    FIELD_SET_DESC(452), // 466
    CLOCK(453), // 467
    sub_C7C220(468),
    sub_C242D0(469),
    sub_C24430(470),
    ...
    sub_C0E770(473),
    // 474 ??????
    SET_QUEST_CLEAR(456), // 477
    SET_QUEST_TIME(457), // 478
    SET_OBJECT_STATE(458), // 479
    DESTROY(459), // 480
    STALK_RESULT(461), // 482
    ...
    // CField::OnPacket
    // Note all the commented values are opcodes for v179 - Brandon
    INIT(464), // 485
    FOOT_HOLD_MOVE(465), // 486
    CORRECT_FOOT_HOLD_MOVE(466), // 487
    FOOT_HOLD_APPEAR(469), // 490
    SMART_MOB_NOTICE(471), // 492
    CHANGE_PHASE(472), // 493
    CHANGE_MOB_ZONE(473), // 494
    PV_P_MIGRATE_INFO_RESULT(475), // 496
    CUR_NODE_EVENT_END(476), // 497
    CREATE_FORCE_ATOM(477), // 498
    SET_ACHIEVE_RATE(478), // 499
    SET_QUICK_MOVE_INFO(479), // 500
    CHANGE_ASWAN_SIEGE_WEAPGAUGE(480), // 501
    CREATE_OBTACLE(481), // 502
    CLEAR_OBTACLE(482), // 503
    B2_FOOT_HOLD_CREATE(484), // 504
    DEBUFF_OBJ_ON(485), // 505
    CREATE_FALLING_CATCHER(486), // 506
    CHASE_EFFECT_SET(487), // 507
    MESO_EXCHANGE_RESULT(488), // 508
    SET_MIRROR_DUNGEINFO(489), // 509
    SET_INTRUSION(490), // 510
    CANNOT_DROP(491), // 511
    FOOT_HOLD_OFF(492), // 512
    LADDER_ROPE_OFF(493), // 513
    MOMENT_AREA_OFF(494), // 514
    MOMENT_AREA_OFF_ALL(495), // 515
    CHAT_LET_CLIENT_CONNECT(496), // 516
    CHAT_INDUCE_CLIENT_CONNECT(497), // 517
    PACKET(498), // 518
    ELITE_STATE(499), // 519
    PLAY_SOUND(500), // 520
    STACK_EVENT_GAUGE(501), // 521
    SET_UNION_FIELD(502), // 522
    // UNKWON FUNCTION/OP CODE sub_BF5D10 523
    STAR_PLANET_BURNING_TIME_INFO(504), // 525
    PUBLIC_SHARE_STATE(505), // 526
    FUNCTION_TEMP_BLOCK(506), // 527
    UI_STATUS_BAR_PACKET(507), // 528
    FIELD_SKILL_DELAY(508), // 529
    WEATHER_PACKET_ADD(509), // 530
    WEATHER_PACKET_REMOVE(510), // 531
    WEATHER_PACKET_MSG(511), // 532
    ADD_WRECKAGE(512), // 533
    DEL_WRECKAGE(513), // 534
    CREATE_MIRROR_IMAGE(514), // 535
    FUNTION_FOOTHOLD_MAN(515), // 536
    sub_BFFDB0(537),
    sub_C261b0(538),
